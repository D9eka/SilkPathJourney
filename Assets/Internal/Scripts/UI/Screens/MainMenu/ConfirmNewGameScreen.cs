...
{
    public class ConfirmNewGameScreen : PopupScreen
    {
        ...
        private ConfirmNewGameScreenViewModel _viewModel;
        private LocalizationService.LocalizedTextGroup _handles;

        public override void BindViewModel(IScreenViewModel viewModel)
        {
            _viewModel = viewModel as ConfirmNewGameScreenViewModel;
        }
        ...
        private void BindLocalization()
        {
            ...
            _handles.Bind(_bodyText, _bodyLocalizedString, "ConfirmNewGame.Body");
            _handles.Bind(_confirmButtonText, _confirmLocalizedString, "ConfirmNewGame.Confirm");
            _handles.Bind(_cancelButtonText, _cancelLocalizedString, "ConfirmNewGame.Cancel");
        }
    }
}
