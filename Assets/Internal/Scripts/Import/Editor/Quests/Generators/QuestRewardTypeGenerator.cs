...
{
    public static class QuestRewardTypeGenerator
    {
        private const string ENUM_NAME = "QuestRewardType";
        private const string CSV_FILE = "quest_reward_types.csv";
        private const string ID_COLUMN = "type_id";
        private const string ENUM_COLUMN = "enum_name";
        private const string OUTPUT_PATH = "Assets/Internal/Scripts/Quests/Generated/QuestRewardType.gen.cs";
