...
{
    public static class QuestFailConditionTypeGenerator
    {
        private const string ENUM_NAME = "QuestFailConditionType";
        private const string CSV_FILE = "quest_fail_condition_types.csv";
        private const string ID_COLUMN = "condition_id";
        private const string ENUM_COLUMN = "enum_name";
        private const string OUTPUT_PATH = "Assets/Internal/Scripts/Quests/Generated/QuestFailConditionType.gen.cs";
